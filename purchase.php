...
<div class="sidebar bg-black p-20 p-relative c-white">
    ...
    <ul>
        ...
        <li>
        <a class= "active d-flex align-center fs-14 c-white rad-6 p-10" href="purchase.php">
    ...
    <div class="content w-full">
      ...
      <div class="head p-15 bg-white between-flex">
          <div class="icons d-flex align-center">
            ...
            <div class="key p-relative">Purchase</div>
          </div>
      ...
      <!-- <h1 class="p-relative">Dashboard</h1> -->
          ...
          <h2 class="mt-0 mb-20">Purchase List</h2>
            ...
            <table class="fs-15 w-full">
              ...
              <tbody>
                <tr>
                  ...
                  <td>445</td>
                  <td>
                    <span class="label btn-shape bg-green c-white">Purchase Order</span>
                  </td>
                </tr>
                <tr>
                  <td>Wikipedia</td>
                  ...
                  <td>445</td>
                  <td>
                    <span class="label btn-shape bg-orange c-white">RFQ</span>
                  </td>
                </tr>
                <tr>
                  <td>Wikipedia</td>
